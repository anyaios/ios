...
-(BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
    ...
    if (textField.tag == 11) {
        NSCharacterSet *setChars = [NSCharacterSet characterSetWithCharactersInString:string];
        NSCharacterSet *chars = [NSCharacterSet characterSetWithCharactersInString:@" 0123456789/:"];
        if ([chars isSupersetOfSet:setChars]) {
            return YES;
        }
...
//    if (textField.tag == 33) {
//
//        //        NSCharacterSet *charsSet = [NSCharacterSet characterSetWithCharactersInString:string];
//        //        NSMutableCharacterSet *chars = [NSMutableCharacterSet letterCharacterSet];
//        //        [chars formUnionWithCharacterSet:[NSCharacterSet uppercaseLetterCharacterSet]];
//        //        if ([chars isSupersetOfSet: charsSet]){
//        //            return YES;
//        //        }
//
//
